...
output_dir = "/mnt/hanoverdev/scratch/hanwen/xyliang/ECHO_dataset_csv/label_dataset_v4_clip/"
...
for task in task_set:
    ...
    for label, split, path in tqdm(zip(df["label"], df["split"], df["path"]), desc=f"Processing {task}"):
