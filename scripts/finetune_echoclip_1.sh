tasks_list=("MV_vegetations" "TV_regurgitation" "TV_stenosis" "TV_vegetations" "PV_regurgitation" "PV_stenosis" "PV_vegetations" "PE" "LVH" "IMT" "IS")
device=cuda:1
num_classes=2
dataset=clip_mini
for task in ${tasks_list[@]}; do
    run_name=${task}_mini_echoclip_freeze
    python run.py --model echoclip_cnn_classifier \
