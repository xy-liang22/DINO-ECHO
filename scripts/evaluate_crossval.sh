...
run_names=("study_original1_multi_videos_fullsize_epoch100_new_crossval" "original1_fullsize_epoch100_new_crossval" "public_epoch100_new_crossval" "echoclip_epoch100_crossval")
    ...
    for i in ${!run_names[@]}; do
        ...
        for fold in $(seq 0 $((folds - 1))); do
            python run.py --model linear_classifier  \
                        ...
                        --output_dir /mnt/hanoverdev/scratch/hanwen/xyliang/ECHO_results_${dataset}/${run_name}/fold_${fold} \
                        --wandb_project ECHO \
                        ...
                        --save_freq 100 \
                        --eval \
                        --resume /mnt/hanoverdev/scratch/hanwen/xyliang/ECHO_results_${dataset}/${run_name}/fold_${fold}/model_best.pth \
                        --n_bootstrap_eval 200
        done
    done
done
