...
class EchoClipAsRegressor(nn.Module):
    def __init__(self,
                 hidden_dim: int=512,
                 **kwargs):
        '''
        ...
        super(EchoClipAsRegressor, self).__init__()
...
def echoclip_cnn_regressor(**kwargs):
    model = EchoClipAsRegressor(hidden_dim=512, **kwargs)
    return model


if __name__ == '__main__':
    model = echoclip_cnn_regressor(num_classes=2).cuda()
