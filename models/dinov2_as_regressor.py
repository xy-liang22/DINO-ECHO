...
class DINOv2AsRegressor(nn.Module):
    def __init__(self, 
                 config_path: str,
                 pretrained: str=None,
                 hidden_dim: int=768,
        ...
        super(DINOv2AsRegressor, self).__init__()
...
def dinov2_large_regressor(**kwargs):
    model = DINOv2AsRegressor(config_path='models/dinov2_modules/configs/train/vitl16_lbsz48_short.yaml', 
                               hidden_dim=1024, 
                               **kwargs)
    return model
...
if __name__ == '__main__':
    ...
    model = dinov2_large_regressor(pretrained=pretrained, num_classes=12).cuda()
