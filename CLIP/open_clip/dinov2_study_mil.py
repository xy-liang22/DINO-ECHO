...
if __name__ == '__main__':
    ...
    model = DINOv2MIL(config_path='open_clip/dinov2_modules/configs/train/vitl16_lbsz48_short.yaml', pretrained=pretrained)
